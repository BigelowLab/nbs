...
You can either manually specify a bound box in (xmin, ymin, xmax, ymax) order,, or provide an `sf`-slike object from whihc the bounding box is extracted. Below we extract 12 months (from 2020), bind as one stars object and display.
