...
extract.sfc_POINT <- function(x, y = NULL, 
  ...
  # 
  # @param tbl table of navigation info, see \code{\link{bsw_nc_nav_point}}
  ...
  nav <- bsw_nc_nav_point(y, x, varname = varname, ...)
  xx <- nav |>
...
extract.sfc_POLYGON <- function(x, y = NULL, 
  ...
  #bb <- xyzt::as_BBOX(x)
  nav <- bsw_nc_nav_bb(y, x, varname = varname, ...)
